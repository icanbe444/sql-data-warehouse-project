...
Script Purpose:
	...
	The Gold layer represents th final dimentsion and facts tables (Star schema)
...
SELECT 
	ROW_NUMBER() OVER(ORDER BY cst_id) AS customer_key,  -- Surrage Key
...
SELECT
ROW_NUMBER() OVER(ORDER BY pn.prd_start_dt,pn.prd_key )AS product_key, -- Surrage Key
